...
def make_tree(S0, sigma, dt, n):
    ...
    for t in xrange(n+1):
        ...
        for num_u in xrange(t+1):
            prices.append(S0*(u**num_u)*(d**(t-num_u)))
...
if __name__ == '__main__':
    print 'CRR'
    my_option = EuropeanCRR(S=Stock(100, .2),
                            K=90,
                            T=1,
                            n=10,
                            r=.05,
                            call=False)
    print my_option.price
    print 'JR'
    my_option = EuropeanJR(S=Stock(100, .2),
                            K=90,
                            T=1,
                            n=10,
                            r=.05,
    ...
    print my_option.price
    print 'Tian'
    my_option = EuropeanTian(S=Stock(100, .2),
                            K=90,
                            T=1,
                            n=10,
                            r=.05,
